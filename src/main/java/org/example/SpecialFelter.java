...
public class SpecialFelter {
    ...
    ChanceKort chanceKort[] = { //Alle vores chancekort minus et par da de tager for lang tid at kode til vores MVP
            ...
            new ChanceKort("De har kørt frem for “fuldt stop”, Betal 1000 kroner i bøde", KortType.ChanceKort, 1, -1000,0),
            new ChanceKort("Betal for vognvask og smøring kr 300", KortType.ChanceKort, 2, -300,0),
            new ChanceKort("Betal kr 200 for levering af 2 kasser øl", KortType.ChanceKort, 3, -200,0),
            new ChanceKort("Betal 3000 for reparation af deres vogn", KortType.ChanceKort, 4, -3000,0),
            new ChanceKort("De har købt 4 nye dæk til Deres vogn, betal kr 1000", KortType.ChanceKort, 5, -1000,0),
            new ChanceKort("De har fået en parkeringsbøde, betal kr 200 i bøde", KortType.ChanceKort, 6, -200,0),
            new ChanceKort("Betal deres bilforsikring, kr 1000", KortType.ChanceKort, 7, -1000,0),
            new ChanceKort("De har været udenlands og købt for mange smøger, betal kr 200 i told.", KortType.ChanceKort, 8, -200,0),
            new ChanceKort("Tandlægeregning, betal kr 2000.", KortType.ChanceKort, 9, -2000,0),
            new ChanceKort("De har vundet i klasselotteriet. Modtag 500 kr.", KortType.ChanceKort, 10,+500,0),
            new ChanceKort("De modtager Deres aktieudbytte. Modtag kr 1000 af banken", KortType.ChanceKort, 11, +1000,0),
            new ChanceKort("Kommunen har eftergivet et kvartals skat. Hæv i banken 3000 kr.", KortType.ChanceKort, 12, +3000,0),
            new ChanceKort("De have en række med elleve rigtige i tipning, modtag kr 1000", KortType.ChanceKort, 13, +1000,0),
            new ChanceKort("Grundet dyrtiden har De fået gageforhøjelse, modtag kr 1000.", KortType.ChanceKort, 14, +1000,0),
            new ChanceKort("Deres præmieobligation er udtrykket. De modtager 1000 kr af banken.", KortType.ChanceKort, 15, +1000,0),
            new ChanceKort("De har solgt nogle gamle møbler på auktion. Modtag 1000 kr af banken.", KortType.ChanceKort, 16, +1000,0),
            new ChanceKort("Værdien af egen avl fra nyttehaven udgør 200 som de modtager af banken", KortType.ChanceKort, 17, +200,0),
            ...
            new ChanceKort("Ryk frem til START", KortType.ChanceKort, 18, 0,0),
            new ChanceKort("Ryk tre felter frem", KortType.ChanceKort, 19, 0,+3),
