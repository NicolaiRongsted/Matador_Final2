...
public class bræt {
    Felter felter[] = { new Felter(1000,50,250,750,2250,4000),
            new Felter(1000,50,250,400,750,2250),
            new Felter(1000,100,600,1800,5400,8000),
            new Felter(1000,100,600,1800,5400,8000),
            new Felter(1000,150,800,2000,6000,9000),
